...
func TestVector3Arithmetic(t *testing.T) {
	...
	t.Run("Div", func(t *testing.T) {
		result := v2.Div(v1)
		if !Equal(result.X(), F32(4.0)) || !Equal(result.Y(), F32(2.5)) || !Equal(result.Z(), F32(2.0)) {
...
func TestVector3VectorOperations(t *testing.T) {
	...
	t.Run("Normalize", func(t *testing.T) {
		...
		if !Equal(normalized.X(), expectedX) || !Equal(normalized.Y(), expectedY) || !Equal(normalized.Z(), F32(0.0)) {
	...
	t.Run("Zero vector normalize", func(t *testing.T) {
		...
		if !Equal(normalized.X(), F32(0.0)) || !Equal(normalized.Y(), F32(0.0)) || !Equal(normalized.Z(), F32(0.0)) {
...
func TestVector3CrossProduct(t *testing.T) {
	...
	cross := v1.Cross(v2)
	// (1,0,0) × (0,1,0) = (0,0,1)
	if !Equal(cross.X(), F32(0.0)) || !Equal(cross.Y(), F32(0.0)) || !Equal(cross.Z(), F32(1.0)) {
